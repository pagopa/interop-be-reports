...
import { getTop10MostSubscribedEServicesPerMacroCategoriesMetric } from '../top-10-most-subscribed-e-services-by-macro-categories-metric.service.js'

describe('getTop10MostSubscribedEServicesByMacroCategoriesMetric', () => {
  it('should return the correct metrics', async () => {
    ...
    const result = await getTop10MostSubscribedEServicesPerMacroCategoriesMetric(readModel)
