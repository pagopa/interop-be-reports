...
const METRICS_FILES = [
  {
    ...
    title: 'PDND - Enti erogatori di e-service',
  ...
  },
  {
    ...
    title: 'PDND - E-service più richiesti - inizio del servizio',
    description: 'I 10 e-service con più enti abilitati, filtrabili per categoria di ente erogatore e fruitore',
    rightsHolderName: 'PCM - Dipartimento per la trasformazione digitale',
    rightsHolderCode: 'AA1D3A2',
    publisherName: 'PagoPA S.p.A.',
  ...
  },
  {
    ...
    description:
      'Il totale degli enti e delle categorie in evidenza che hanno aderito a PDND Interoperabilità, con la variazione dal mese precedente',
    rightsHolderName: 'PCM - Dipartimento per la trasformazione digitale',
    rightsHolderCode: 'AA1D3A2',
    publisherName: 'PagoPA S.p.A.',
    publisherCode: '5N2TR557',
  ...
  {
    fileKey: 'andamentoDelleAdesioniPerCategoriaLastSixMonths',
    filename: getFilename('andamentoDelleAdesioniPerCategoriaLastSixMonths'),
    title: 'PDND - Andamento delle adesioni per categoria di ente pubblico - ultimi 6 mesi',
  ...
  {
    fileKey: 'andamentoDelleAdesioniPerCategoriaLastTwelveMonths',
    filename: getFilename('andamentoDelleAdesioniPerCategoriaLastTwelveMonths'),
    title: 'PDND - Andamento delle adesioni per categoria di ente pubblico - ultimi 12 mesi',
    description: 'Percentuale di adesione degli enti sul totale della categoria',
    rightsHolderName: 'PCM - Dipartimento per la trasformazione digitale',
    rightsHolderCode: 'AA1D3A2',
    publisherName: 'PagoPA S.p.A.',
  ...
  {
    fileKey: 'andamentoDelleAdesioniPerCategoriaFromTheBeginning',
    filename: getFilename('andamentoDelleAdesioniPerCategoriaFromTheBeginning'),
    title: 'PDND - Andamento delle adesioni per categoria di ente pubblico - inizio del servizio',
    description: 'Percentuale di adesione degli enti sul totale della categoria',
    rightsHolderName: 'PCM - Dipartimento per la trasformazione digitale',
    rightsHolderCode: 'AA1D3A2',
    publisherName: 'PagoPA S.p.A.',
  ...
  },
  {
    ...
    title: 'PDND - Connessioni fra enti - ultimi 6 mesi',
  ...
  },
  {
    ...
    title: 'PDND - Connessioni fra enti - ultimi 12 mesi',
    description: 'I 10 enti erogatori che hanno abilitato più connessioni con gli enti fruitori',
    rightsHolderName: 'PCM - Dipartimento per la trasformazione digitale',
    rightsHolderCode: 'AA1D3A2',
    publisherName: 'PagoPA S.p.A.',
  ...
  },
  {
    ...
    title: 'PDND - Connessioni fra enti - inizio del servizio',
    description: 'I 10 enti erogatori che hanno abilitato più connessioni con gli enti fruitori',
    rightsHolderName: 'PCM - Dipartimento per la trasformazione digitale',
    rightsHolderCode: 'AA1D3A2',
    publisherName: 'PagoPA S.p.A.',
