...
<<<<<<<< HEAD:jobs/dtd-metrics/src/metrics/__tests__/total-tenants-count.metric.test.ts
...
>>>>>>>> 1.0.x:jobs/dtd-metrics/src/metrics/__tests__/onboarded-tenants-count.metric.test.ts
  })
})
